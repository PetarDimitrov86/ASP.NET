    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CameraBazaar.Data.CameraBazaarContext>
    {
        ...
        protected override void Seed(CameraBazaar.Data.CameraBazaarContext context)
        {
            ...
            context.Users.AddOrUpdate(u => u.Username,
                new User { Email = "admin@gmail.com", Phone = "+123456789101", Password = "admin", Username = "admin"},
                new User { Email = "pesho@gmail.com", Phone = "+99933366622", Password = "123", Username = "pesho" },
                new User { Email = "lidinka@abv.bg", Phone = "+334455667788", Password = "123", Username = "lidinka" });
