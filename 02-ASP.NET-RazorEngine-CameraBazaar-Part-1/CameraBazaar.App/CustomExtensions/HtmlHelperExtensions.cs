namespace CameraBazaar.App.CustomExtensions
{
    ...
    public static class HtmlHelperExtensions
    {
        ...
        public static MvcHtmlString Image(this HtmlHelper helper, string imageUrl, string alt = "", string width = "120", string height = "100")
        {
            TagBuilder builder = new TagBuilder("img");
            builder.AddCssClass("thumbnail");
